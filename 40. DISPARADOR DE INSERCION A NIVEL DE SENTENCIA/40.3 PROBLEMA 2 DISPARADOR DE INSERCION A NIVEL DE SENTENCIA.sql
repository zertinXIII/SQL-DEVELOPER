...
1. Establezca el formato de fecha para que muestre "DD/MM/YYYY HH24:MI":

    alter session set NLS_DATE_FORMAT = 'DD/MM/YYYY HH24:MI';

2. Cree un disparador que se dispare cuando se ingrese un nuevo registro en "ofertas"; el trigger debe ingresar en la tabla "control", el nombre del usuario, la fecha y la hora 
en la cual se realizó un "insert" sobre "ofertas"

    CREATE OR REPLACE TRIGGER TR_INGRESAR_OFERTAS
         BEFORE INSERT
         ON OFERTAS -- TABLA DE OFERTAS
     BEGIN
        INSERT INTO CONTROL VALUES (USER,SYSDATE);
    END TR_INGRESAR_OFERTAS;
    /
    
3. Vea qué informa el diccionario "user_triggers" respecto del trigger anteriormente creado

    SELECT *
    FROM USER_TRIGGERS 
        WHERE TRIGGER_NAME='TR_INGRESAR_OFERTAS';

4. Ingrese algunos registros en "libros"
...
5. Ingrese en "ofertas" los libros de "libros" cuyo precio no superen los $30, utilizando la siguiente sentencia:
...
6. Verifique que el trigger se disparó consultando la tabla "control"
